...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--id', default='MODEL_ID',
        ...
        parser.add_argument('--weights_tnet', default='',
                            help="weights to finetune net_temporal")
        ...
        parser.add_argument('--num_vis', default=20, type=int,
                            help='number of images to evalutate')
        parser.add_argument('--audLen', default=11025, type=int,
                            help='sound length')
        ...
        parser.add_argument('--frameRate', default=32, type=float,
    ...
    def add_train_arguments(self):
        ...
        parser.add_argument('--list_train',
                            default='YOUR_TRAIN_FILE')
        parser.add_argument('--list_val',
                            default='YOUR_TEST_FILE')
